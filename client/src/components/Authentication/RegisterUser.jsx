...
const RegisterUser = () => {
    ...
    return (
        ...
        <div className='signupPageDiv' style={{display:"flex",alignItems:"center"}}>
            <div className='card-div m-0 signupP' style={{padding: "4em 6em 1em", maxWidth: "100vw",height:"100vh" ,backgroundColor:"white"}}>
